...
- The serial and parallel mesh types have been renamed from `SerialTreeMesh`, `TreeMeshParallel`, `SerialP4estMesh`, `P4estMeshParallel`, `SerialT8codeMesh`, and `T8codeMeshParallel` to `TreeMeshSerial`, `TreeMeshParallel`, `P4estMeshSerial`, `P4estMeshParallel`, `T8codeMeshSerial`, and `T8codeMeshParallel`, respectively ([#2787]).
