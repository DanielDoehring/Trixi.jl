...
mutable struct PairedExplicitRelaxationRK2MultiIntegrator{RealT <: Real,
    ...
    const alg::PairedExplicitRK2Multi
...
mutable struct PairedExplicitRelaxationRK2MultiParabolicIntegrator{RealT <: Real,
                                                                   uType <:
                                                                   AbstractVector,
                                                                   Params, Sol, F,
                                                                   PairedExplicitRKOptions,
