...
mutable struct PairedExplicitRelaxationRK3MultiIntegrator{RealT <: Real, uType <: AbstractVector,
                                                          Params, Sol, F,
...
mutable struct PairedExplicitRelaxationRK3MultiParabolicIntegrator{RealT <: Real, uType <: AbstractVector,
                                                                   Params, Sol, F,
                                                                   PairedExplicitRKOptions,
                                                                   RelaxationSolver} <:
...
function init(ode::ODEProblem, alg::PairedExplicitRelaxationRK3Multi;
    ...
    if !mpi_isparallel()
        partition_variables!(level_info_elements,
                             ...
                             n_levels, mesh, dg, cache, alg.PERK3Multi)
