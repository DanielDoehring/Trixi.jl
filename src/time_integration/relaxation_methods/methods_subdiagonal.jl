...
Six-stage, fourth-order Low-Dissipation, Low-Dispersion Runge-Kutta method implemented as a [`SubDiagonalAlgorithm`](@ref).
The weight vector is given by
``\\boldsymbol b = [-3.94810815871644627868730966001274,
...
and the abscissae/timesteps by
``\\boldsymbol c = [0.0,
...
- Tselios, Simos (2005).
  ...
  [DOI: 10.1016/j.cam.2004.06.012](https://doi.org/10.1016/j.cam.2004.06.012)
"""
...
"""
    RelaxationTS64(; relaxation_solver = RelaxationSolverNewton())

Relaxation version of the six-stage, fourth-order Low-Dissipation, Low-Dispersion Runge-Kutta method [`TS64()`](@ref),
implemented as a [`SubDiagonalRelaxationAlgorithm`](@ref).
The default relaxation solver [`AbstractRelaxationSolver`](@ref) is [`RelaxationSolverNewton`](@ref).
"""
