...
# Create ODE problem
tspan1 = (0.0, 400.0)
tspan1 = (0.0, 10.0) # For removing type instab only
...
#ode_alg = CarpenterKennedy2N54(williamson_condition = false, thread = Trixi.True())
#ode_alg = RK4(thread = Trixi.True())
#ode_alg = NDBLSRK144(williamson_condition = false, thread = Trixi.True())
#ode_alg = CFRLDDRK64(thread = Trixi.True())
#ode_alg = TSLDDRK74(thread = Trixi.True())
