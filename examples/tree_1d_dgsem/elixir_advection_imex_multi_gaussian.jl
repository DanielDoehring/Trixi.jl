...
semi_real = SemidiscretizationHyperbolic(mesh, equations, ic_gauss, solver_real)

# `semi_float` is used for the subsequent simulation
semi_float = SemidiscretizationHyperbolic(mesh, equations, ic_gauss, solver_float)
