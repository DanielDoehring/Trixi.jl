...
# Note: These are 1e-2 in the original example
mu() = 1e-2
eta() = 1e-2 
...
boundary_condition_free = BoundaryConditionVRMHDWall(velocity_bc_free, heat_bc_free, magnetic_bc_free)
...
boundary_condition_cylinder = BoundaryConditionVRMHDWall(velocity_bc_cylinder, heat_bc_cylinder, magnetic_bc_cylinder)
