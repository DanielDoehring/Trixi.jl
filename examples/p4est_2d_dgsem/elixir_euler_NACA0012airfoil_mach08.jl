...
mach_inf() = 0.85
aoa() = 1.25 * pi / 180.0 # 1.25 Degree angle of attack
...
boundary_conditions = Dict(:Inflow => boundary_condition_subsonic_constant,
                           :Outflow => boundary_condition_subsonic_constant,
