...
#stepsize_callback = StepsizeCallback(cfl = 1.0) # CarpenterKennedy2N54
stepsize_callback = StepsizeCallback(cfl = 0.4) # PERK 4 Single E = 10
stepsize_callback = StepsizeCallback(cfl = 0.4) # PERK 4 Single E = 7
stepsize_callback = StepsizeCallback(cfl = 0.4) # PERK 4 Single E = 5
...
#Stages = [16, 10, 7, 6, 5]
Stages = [10, 7, 6, 5]
#ode_alg = PERK4_Multi([10], "/home/daniel/git/MA/EigenspectraGeneration/PERK4/EulerGravity/Euler/", [42])

ode_alg = PERK4(5, "/home/daniel/git/MA/EigenspectraGeneration/PERK4/EulerGravity/Euler/")
